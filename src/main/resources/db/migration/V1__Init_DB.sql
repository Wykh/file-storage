...
CREATE TABLE get_role_history_entity
(
    id             int8 GENERATED BY DEFAULT AS IDENTITY,
    actor_user_id  int8,
    target_user_id int8,
...
CREATE UNIQUE INDEX get_role_history_entity_id_uindex
    ON get_role_history_entity (id);
...
ALTER TABLE get_role_history_entity
    ADD CONSTRAINT FK_actor_user_id FOREIGN KEY (actor_user_id) REFERENCES user_entity;

ALTER TABLE get_role_history_entity
    ADD CONSTRAINT FK_target_role_id FOREIGN KEY (target_user_id) REFERENCES user_entity;